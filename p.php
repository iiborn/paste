<?php
     define('BOT_TOKEN','310295822:AAEndzmFJKv89TIcl_vqmn1GFT3rLG5VW-s');
...
{
typing($chat_id);
sendMessage($chat_id,"سلام $chat_name ?????");
}
...
{
typing($chat_id);
sendMessage($chat_id,'??خطا??لطفا يه لينک بفرستيد.??دقت کنيد لينک با http:// يا https:// شروع شود??',$msg_id);
}
?>
